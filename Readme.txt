...
2. Заполнил таблицу данными с сайта http://www.cbr.ru/development/SXML/ за 30 дней.
...
4. Страница просмотра валют по дате (currencies.php) доступна после авторизации. Проверка при помощи SESSION.
